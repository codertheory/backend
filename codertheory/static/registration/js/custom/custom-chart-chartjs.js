...
$(document).ready(function () {
    ...
    var lineDiffPoint = new Chart(lineDiffPointID, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: ["#e9eff9"],
                pointBorderColor: ["transparent", "transparent", "transparent", "transparent", "transparent", "transparent", "transparent"],
                pointBackgroundColor: ["#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9"],
                fill: false,
    ...
    var multiAxisBarChart = new Chart(multiAxisBarChartID, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Series A',
                backgroundColor: ["#944dff", "#ffe411", "#e9eff9", "#08d26f", "#fc4f68", "#81cef6", "#2e2e2e"],
                yAxisID: 'y-axis-1',
    ...
    var stackedBarChart = new Chart(stackedBarChartID, {
        ...
        data: {
            ...
            datasets: [{
                ...
                label: 'Series C',
                backgroundColor: ["#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9"],
    ...
    var lineBarMixed = new Chart(lineBarMixedID, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: ["#e9eff9"],
                pointBorderColor: ["#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9"],
                pointBorderWidth: 2,
                pointBackgroundColor: ["#ffffff", "#ffffff", "#ffffff", "#ffffff", "#ffffff", "#ffffff", "#ffffff"],
    ...
    var datasetArea = new Chart(datasetAreaID, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ["rgba(233,239,249,0.5)"],
                borderColor: ["#e9eff9"],
                pointBorderColor: ["#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9", "#e9eff9"],
                pointBackgroundColor: ["#ffffff", "#ffffff", "#ffffff", "#ffffff", "#ffffff", "#ffffff", "#ffffff", "#ffffff"],
                pointBorderWidth: 2,
    ...
    var polarAreaChart = new Chart(polarAreaChartID, {
        ...
        data: {
            datasets: [{
                data: [65, 91, 56, 84, 47],
                borderColor: 'transparent',
                backgroundColor: ["rgba(252,79,104,0.5)", "rgba(148,77,255,0.5)", "rgba(255,228,17,0.5)", "rgba(233,239,249,0.5)", "rgba(8,210,111,0.5)"],
                label: 'Dataset 1'
            }],
